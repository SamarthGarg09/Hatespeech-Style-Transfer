...
# test
text_orig = ['I love this place!', 'I hate this place!']
text_transferred = ['I hate this place!', 'I love this place!']
evaluator = Evaluator()
print('yelp_acc_0: ', evaluator.yelp_acc_0(text_transferred))